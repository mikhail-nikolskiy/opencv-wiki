...
* add extra drawing functions (maybe to imgproc module) to visualize various useful objects: dashed rectangles and other figures, fancy targets (like ![4-corner border](https://www.fileformat.info/info/unicode/char/26f6/square_four_corners.png)), arrows etc.
