...
This community package uses open source version of Inference Engine from [Deep Learning Deployment Toolkit repository](https://github.com/opencv/dldt) (distributed under Apache 2 license).

Hardware requirements:
- CPU with support of AVX2 instruction set
- *[optional]* Intel® Integrated Graphics
- *[optional]* Intel® Movidius™ Neural Compute Stick (NCS), Intel® Neural Compute Stick 2
