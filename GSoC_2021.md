...
| ------------------------ | ------------------------- | -------------- | ----------------- |
| [ Fiducial Tags](https://github.com/opencv/opencv/wiki/GSoC_2021#idea-create-robust-visual-fiducial-tags) | 
[&nbsp; 4: Calibration](https://github.com/opencv/opencv/wiki/GSoC_2020#idea-calibration-improvements) |
