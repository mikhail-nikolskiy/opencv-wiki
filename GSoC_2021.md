...
[Weed control](https://opencv.org/smarter-more-precise-weed-management-with-phenocv-weedcam/) by Paula Giraldo 

* _[[Parent page|OpenCV_GSoC]]_
* _[[Last year|GSoC_2020]]_
...
- 🚧  **Update to 2021** [OpenCV Project Ideas List](https://github.com/opencv/opencv/wiki/GSoC_2020#OpenCV-project-ideas-list)
...
4.  You then:
    ...
    - You will get a list of students who have applied to your project. Go through them and select a student or rejecting them all if none suits and joining to co-mentor or to quit this year are acceptable outcomes.
       - Make sure your students officially apply through the [Google Summer of Code site](https://summerofcode.withgoogle.com) prior to the deadline as indicate on the [time line](https://github.com/opencv/opencv/wiki/GSoC_2021#important-dates)
