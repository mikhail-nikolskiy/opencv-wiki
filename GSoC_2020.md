...
#### _IDEA:_ Write a tutorial about training a network in PyTorch and then running it in OpenCV
...
#### _IDEA:_ Write a tutorial about using universal intrinsics and `cv::parallel_for_` for efficient cross-platform algorithm implementation
...
#### _IDEA:_ Computer vision data augmentation module
...
#### _IDEA:_ Add automatically generated Julia bindings for OpenCV
...
#### _IDEA:_ Create nuget package for OpenCV and OpenCV contrib.
