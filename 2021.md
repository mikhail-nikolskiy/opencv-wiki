...
* Vadim
   * Tried Orbbec's Astra 3D camera — works great in Parallels running Linux (Ubuntu 20.04) on Mac. Found one little problem, will submit patch soon. Kinect fusion sample was fixed to run on Astra camera. PR submitted.
   ...
   * There is some noticeable progress on Ficus compiler in the past 2 days, 1 major feature and 2 smaller features have been implemented.
