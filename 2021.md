...
* Shiqi:
   * Working on face detection model. Trained 2 models: 1. face + 5 landmarks, 2. face + 26 landmarks, very efficient and very compact. Size ~100Kb (5 landmarks), 250Kb (26 landmarks). Can possibly embed those models into OpenCV.
* Stefano:
