...
* Vadim GSoC OpenCV projects
   * Text detection -- from OCR Shiqui Yu
   * Text detection/recognition -- 
   * Ransac improvements later this week
   * Wrote the guy on Julia bindings
   * RISC-V support
   * Going to write on SIFT improvements
* Vincent
   * <suppressed info for now>
