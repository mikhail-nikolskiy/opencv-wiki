...
1. Vadim:
   - GSoC: the 2nd round of evaluations. 10 evaluations are not complete yet.
...
1. Anna:
   - tested a bunch of PR this week
   - RISC-V project: finally managed to build RISC-V and run it on QEMU with RVV.
...
1. Vladimir:
   - GSoC projects & OSPP projects are under control. all submitted PRs.
