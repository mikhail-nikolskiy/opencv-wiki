 ...
 * Vadim Pisarevsky works on concept of algorithms quality benchmarking. Major targets: non DNN algos like RANSAC, Hough Transform, pattern detection (chess board, checker board), QR code detection, etc.
